...
**Description:** A community-driven platform with AI-powered tools for game creation, sharing, and playtesting
...
- **title:** Object with default and template
  - default: "GameForge"
  - template: "%s | GameForge" (for page-specific titles)

- **description:** "Create Play Share"
...
- "/" → "GameForge"
- "/login" → "Sign In | GameForge"
- "/signup" → "Sign Up | GameForge"
- "/dashboard" → "Dashboard | GameForge"
