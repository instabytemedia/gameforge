...
**Product:** GameForge
**Protected Routes:** /dashboard, /account, /games, /users
**Onboarding:** 3 steps
...
**Steps:**
1. Create an Account: Sign up for an account to start creating and playing games
2. Create a Game: Use our AI-powered game creator to bring your board game idea to life
3. Playtest a Game: Playtest a game and provide feedback to help improve it
